...
#define METAL_SOUND_FLAG (MARIO_METAL_CAP | (MARIO_WING_CAP & (gLevelOptions->game == MB_GAME_BTCM)) )
...
#define ACT_CROUCH_SLIDE               0x04008459 // (0x059 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ALLOW_FIRST_PERSON)
