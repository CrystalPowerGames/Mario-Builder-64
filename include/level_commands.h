...
enum LevelCommands {
    ...
    /*0x43*/ LEVEL_CMD_LOAD_MB,
    /*0x44*/ LEVEL_CMD_LOAD_MB_MODELS,
};
...
#define LOAD_MB() \
    CMD_BBH(LEVEL_CMD_LOAD_MB, 0x04, 0x0000)

#define LOAD_MB_MODELS() \
    CMD_BBH(LEVEL_CMD_LOAD_MB_MODELS, 0x04, 0x0000)
