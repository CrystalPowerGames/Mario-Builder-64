...
#define SET_OBJ_PHYSICS_DEFAULT(wallHitboxRadius) \
    SET_OBJ_PHYSICS(wallHitboxRadius, MB_GRAVITY_DEFAULT, MB_BOUNCINESS_DEFAULT, MB_DRAG_DEFAULT, MB_FRICTION_DEFAULT, MB_BUOYANCY_DEFAULT, 0, 0)

#define SET_OBJ_PHYSICS_AIR(wallHitboxRadius) \
    SET_OBJ_PHYSICS(wallHitboxRadius, 0, 0, MB_DRAG_DEFAULT, MB_FRICTION_DEFAULT, 0, 0, 0)
...
const BehaviorScript bhvMrI[] = {
    ...
    SET_FLOAT(oDrawingDistance, MB_DRAWDIST_LOW),
    BILLBOARD(),
    //CALL_NATIVE(bhv_init_room),
    BEGIN_LOOP(),
...
const BehaviorScript bhvKingBobomb[] = {
    ...
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, MB_DRAWDIST_MEDIUM),
    SET_HOME(),
...
const BehaviorScript bhvGrindel[] = {
    ...
    SET_HOME(),
    SET_INT(oAction, 1),
    SET_FLOAT(oDrawingDistance, MB_DRAWDIST_HIGH),
...
//     DROP_TO_FLOOR(),
    ...
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, MB_DRAWDIST_LOW),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ MB_GRAVITY_DEFAULT, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ MB_FRICTION_DEFAULT, /*Buoyancy*/ MB_BUOYANCY_DEFAULT, /*Unused*/ 0, 0),
    SCALE(/*Unused*/ 0, /*Field*/ 150),
...
const BehaviorScript bhvMrBlizzardSnowball[] = {
    ...
    BILLBOARD(),
// Less gravity
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -300, /*Bounciness*/ MB_BOUNCINESS_DEFAULT, /*Drag strength*/ MB_DRAG_DEFAULT, /*Friction*/ MB_FRICTION_DEFAULT, /*Buoyancy*/ MB_BUOYANCY_DEFAULT, /*Unused*/ 0, 0),
    SCALE(/*Unused*/ 0, /*Field*/ 200),
    SET_FLOAT(oDrawingDistance, MB_DRAWDIST_LOW),
...
const BehaviorScript bhvSkeeter[] = {
    ...
    SET_FLOAT(oDrawingDistance, MB_DRAWDIST_LOW),
// Higher buoyancy
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 110, /*Gravity*/ MB_GRAVITY_DEFAULT, /*Bounciness*/ MB_BOUNCINESS_DEFAULT, /*Drag strength*/ MB_DRAG_DEFAULT, /*Friction*/ MB_FRICTION_DEFAULT, /*Buoyancy*/ 1200, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
